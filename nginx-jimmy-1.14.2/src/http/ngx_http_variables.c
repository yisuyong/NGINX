...
//    ngx_log_debug1(NGX_LOG_DEBUG_HTTP, r->connection->log, 0,"suyong http test4-0 log : %d",index);
    ...
    //ngx_log_debug1(NGX_LOG_DEBUG_HTTP, r->connection->log, 0,"suyong http test4-1 log : %V",&v[index].name);
