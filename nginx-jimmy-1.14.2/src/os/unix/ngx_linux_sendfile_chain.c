...
//	    ngx_log_debug1(NGX_LOG_DEBUG_EVENT, c->log, 0,"suyong sent content: %uz", n); //정확한 값확 인
...
//		ngx_log_debug1(NGX_LOG_DEBUG_EVENT, c->log, 0,"suyong sent header: %uz", n); 
            sent = (n == NGX_AGAIN) ? 0 : n;
        }
	...
	ngx_log_debug1(NGX_LOG_DEBUG_EVENT, c->log, 0,"suyong sent: %uz", c->sent); 
...
//		ngx_log_debug1(NGX_LOG_DEBUG_EVENT, c->log, 0,"suyong send done: %uz", c->sent); //정상 종료
            return in;
        }
    }
}
