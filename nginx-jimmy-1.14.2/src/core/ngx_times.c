...
volatile ngx_str_t       ngx_cached_http_log_korean;
...
static u_char            cached_http_log_korean[NGX_TIME_SLOTS]
...
ngx_time_init(void)
{
    ...
    ngx_cached_http_log_korean.len = sizeof("1970.09.28 12:00:00") - 1;
...
ngx_time_update(void)
{
    ...
    p5 = &cached_http_log_korean[slot][0];
    ...
    ngx_cached_http_log_korean.data = p5;
